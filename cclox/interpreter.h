...
class Interpreter {
 ...
 private:
   ...
   */
  auto Greater(const Object& left, const Token& op, const Object& right)
      const -> bool;
   ...
   * @return true if left < right, false otherwise
   */
  auto Less(const Object& left, const Token& op, const Object& right) const -> bool;
   ...
   */
  auto Subtract(const Object& left, const Token& op, const Object& right)
      const -> Object;
   ...
   */
  auto Add(const Object& left, const Token& op, const Object& right) const -> Object;
   ...
   */
  auto Divide(const Object& left, const Token& op, const Object& right)
      const -> Object;
   ...
   */
  auto Multiply(const Object& left, const Token& op, const Object& right)
      const -> Object;
  ...
  auto GetNumberOperands(const Object& left, const Token& op,
                         const Object& right) const -> std::pair<double, double>;
};
}  // namespace cclox
